...
/short/rl2/miniconda3/envs/snakemake/bin/snakemake -s /home/150/sxk150/HP1-alpha/snakemake/Snakefile all\
        --configfile /home/150/sxk150/HP1-alpha/snakemake/configs/config_ChIP-Seq.json\
        --use-conda\
        --jobs 32\
